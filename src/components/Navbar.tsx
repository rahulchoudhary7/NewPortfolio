   ...
   return (
      <>
         ...
         <div
            ...
            } bg-black/70 md:hidden fixed top-0 left-0 z-50 flex flex-col text-gray-100 items-center p-4 min-h-screen`}
         >
            <button
               onClick={() => {
         ...
         {/* Desktop Navbar */}
         <div className='bg-black/70 hidden md:flex w-[90%] lg:w-[80%] rounded-full my-8 h-16 p-2'>
            <div className='flex flex-wrap w-full gap-4 md:gap-10 text-gray-100 items-center justify-center p-2 shadow-md shadow-gray-800 rounded-full'>
               ...
               <button className='text-base md:text-lg font-normal cursor-pointer'>
