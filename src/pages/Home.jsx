               ...
               <HeroHighlight>
                  <div id='home' className='overflow-hidden bg-black w-full pt-24'>
                     <div className='flex items-center flex-col mt-[-100]'>
                       ...
                       <div className='text-5xl md:text-8xl font-medium min-h-[100px] fixed-height mx-auto text-neutral-400 mb-5'>
   {currentText}
</div>
                           ...
                           <CardBody className='bg-gray-50 relative group/card  hover:shadow-2xl hover:shadow-emerald-500/[0.1] bg-black border-white/[0.2]  w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  '>
                              <div className='flex gap-2'>
                                 ...
                                 >
                                    ...
                                    <p className='text-xs'>Jan 2024 - Present</p>
                                 </CardItem>
                              </div>
                              <CardItem
                                 translateZ='80'
                              ...
                              /> */}
                                 <div className='p-4'>
                                    • Developing a scalable internal application using React.js and
                                    Spring Boot to enhance user experience and operational
                                    efficiency.
                                    <br />
                                    <br />
                                    • Contributing to fortifying system security by implementing
                                    advanced authentication protocols (JWT & Microsoft Auth) to
                                    safeguard sensitive campus data. <br />
                                    <br />• Collaborating with stakeholders to translate needs into
                                    actionable development plans, ensuring project alignment with
                                    business goals.
                                 </div>
                              </CardItem>
